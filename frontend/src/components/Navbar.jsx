...
const Navbar = ({user={},onLogout}) => {
    ...
    const handleMenueToggle = ()=> setMenueOpen((prev) => !prev)
    const handleLogout = () => {
        setMenueOpen(false)
        onLogout();
    }
          ...
          <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
             ...
             <div className='flex items-center gap-4'>
                ...
                <div ref={menuref} className='relative'>
                       <button onClick={handleMenueToggle} className=' flex items-center gap-2 px-3 py-2 rounded-full
                       cursor-pointer hover:bg-purple-50 transition-colors duration-300 border border-transparent hover:border-purple-200'>
